...
def spin_factory(default, min, max, callback, toolbar):
    spin_adj = Gtk.Adjustment(value=default, lower=min, upper=max,
                              step_increment=1, page_increment=32, page_size=0)
    spin = Gtk.SpinButton(adjustment=spin_adj, digits=0)
