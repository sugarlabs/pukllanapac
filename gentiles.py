...
C = [[Y, B, Y, R], [R, Y, Y, R], [R, R, Y, R], [R, R, R, R], [B, B, B, Y],
     [Y, B, Y, Y], [R, R, B, Y], [R, B, R, R], [R, R, Y, B], [B, B, R, R],
     [R, B, B, Y], [B, R, B, R], [B, B, B, B], [R, B, B, B], [B, Y, B, Y],
     [R, Y, Y, B], [Y, Y, B, B], [Y, Y, Y, Y], [Y, Y, R, B], [Y, R, Y, Y],
     [Y, R, B, R], [R, Y, R, Y], [R, B, Y, B], [Y, B, B, R]]
